...
class SimpleTweetEnricher:
    ...
    def _enrich_single_project_tweet(self, tweet: Tweet, 
        ...
        try:
            ...
            self.logger.info(f"项目推文 {tweet.id_str} 简化增强完成: kol_id={tweet.kol_id}, sentiment={tweet.sentiment}, is_announce={tweet.is_announce}, is_activity={tweet.is_activity}")
            return tweet
